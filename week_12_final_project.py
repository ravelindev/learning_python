...
print("\n\n\n") # print a blank line
print("Now we will look data for a specific country in a specific year") # print a message
# Ask the user if they want to see the data for a country   
user_country = input("\nDo you want to see the data for a country?:  ") # ask the user if they want to see the data for a country
user_specific_year = input("\nPlease enter the specific year?:  ") # ask the user if they want to see the data for a specific year
if user_country.lower() == "yes": # if the user input is yes
    user_country = input("\nPlease enter the country:  ") # ask the user what country they want to see
    for index in life_information: # iterate through the life information
        if index[0] == user_country: # if the country is the same as the user input
          if index[2] == user_specific_year:
            print(f"\nThe life expectancy for {user_country} in {user_specific_year} is {index[3]} years.") # print the life exp for the specified country and year
